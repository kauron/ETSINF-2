...
inicializa_reloj_en_s:
				...
				# Esta subrutina emplea sll y add en vez de mult
...
devuelve_reloj_en_s_sd:
				...
				and $t0, $t0, $t1	# Hours in t0
				sll $t2,$t0,6		# t2 = hours * 64
				sll $t1,$t0,2		# t1 = hours * 4
				sub $t2,$t2,$t1		# t2 = hours * 64 - hours * 4 = hours * 60
				lb $t0, 1($a0)		# Load minutes
				li $t1, 0x3f		# Clean minutes
				and $t0, $t0, $t1
				add $t0, $t0, $t2	# minutes = hours * 60 + minutes
				sll $t2,$t0,6		# t2 = minutes * 64
				sll $t1,$t0,2		# t1 = minutes * 4
				sub $t2,$t2,$t1		# t2 = minutes * 64 - minutes * 4 = minutes * 60
